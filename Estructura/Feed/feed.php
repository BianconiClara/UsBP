...
<head>
    ...
    <title>UsBP - Feed</title>
    <link rel="icon" type="image/x-icon" href="../../Media/favicon.ico">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-sRIl4kxILFvY47J16cr9ZwB07vP4J8+LH7qKQnuqkuIAvNWLzeN8tE5YBujZqJLB" crossorigin="anonymous">
    <link rel="stylesheet" href="feed_styles.css">
</head>
<body>
    ...
    <nav class="fixed-bottom" style="background-color: var(--rojo-usbp);">
        <div class="d-flex justify-content-center py-3">
            <ul class="nav nav-pills gap-4">
                <li class="nav-item">
                    <a href="../Feed/feed.php" class="nav-link" style="color: var(--rojo-usbp); background-color: var(--blanco-usbp);" aria-current="page">
        ...
        <div class="album album-publicaciones">
            ...
            <div class="container">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    ...
                    <?php
                    //Muestro los productos de la carta
                    include("extraer_feed.php");
                    ?>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        botones.forEach(boton => {
            boton.addEventListener("click", () => {
                ...
                //Envio al servidor un post hacia like.php con el id
                fetch("like.php", {
                    method: "POST",
