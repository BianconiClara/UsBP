...
//Extraigo el id del tema por get
$id_tema = intval($_GET["id"]); //Tambien convierto a int

//Llamo a BD
include("../../../PHP Src/BD/conexion.php");

//Obtengo la información de todos los posts que tengan el id del tema solicitado
$sql = "SELECT * FROM posts WHERE id_tema = $id_tema ORDER BY id DESC ;"; //Ultimas publicaciones primero
$posts = mysqli_query(conectar(), $sql);

//Verifico si hay publicaciones sobre ese tema
