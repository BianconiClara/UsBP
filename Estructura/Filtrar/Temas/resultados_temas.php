...
<head>
    ...
    <title>UsBP - Filtrado por Tema</title>
    <link rel="icon" type="image/x-icon" href="../../../Media/favicon.ico">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-sRIl4kxILFvY47J16cr9ZwB07vP4J8+LH7qKQnuqkuIAvNWLzeN8tE5YBujZqJLB" crossorigin="anonymous">
    <link rel="stylesheet" href="resultados_temas_styles.css">
</head>
<body>
    ...
    //Extraigo el nombre del tema por get
    $nombre_tema = $_GET["nom"];
    ?>
    ...
    <main>
        <div class="album album-publicaciones">
            ...
            <h2><?php echo $nombre_tema;?></h2>

            <div class="container">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">

                    <?php
                    //Extraigo los posts del tema
                    include("extraer_por_tema.php");
                    ?>
